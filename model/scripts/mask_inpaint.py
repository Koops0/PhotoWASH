...
def add_random_mask(img, size=None, mask_root='CycleRDM/scripts/inpainting_masks', mask_id=-1, n=100):
    if mask_id < 0:
...
target_dir = '/home/ubuntu/Image-restoration/CycleRDM/data/11/1/'
source_dir = '/home/ubuntu/Image-restoration/CycleRDM/data/11/1/'
